    ...
    if Config.Input == 'ox' then
        ...
        if Config.Progressbar == 'qb' then
            QBCore.Functions.Progressbar("forging", Lang:t('Progressbar.Forging'), Config.ForgeTime * 1000, false, true, {
                ...
                TriggerServerEvent('mtc-fakecard:Server:setIdentity', input, data.vData.Price, data.item)
            end, function()
                return
            end)
        elseif Config.Progressbar == 'ox' then
            ...
            }) then TriggerServerEvent('mtc-fakecard:Server:setIdentity', input, data.vData.Price, data.item) else return end
        end
